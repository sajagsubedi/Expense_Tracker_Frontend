    ...
    <main className="min-w-screen min-h-screen bg-gray-950 flex flex-col items-center pt-20">
      <form className="w-80 md:w-96 bg-gray-900 rounded-md drop-shadow-xl flex flex-col px-4 py-3 gap-3 justify-center items-center">
        ...
        <div className="flex w-full flex-col">
          <label htmlFor="name" className="leading-7 text-base text-gray-400">
            Full Name
          </label>
          <input
            type="text"
        ...
        <div className="flex w-full flex-col">
          <label htmlFor="gender" className="leading-7 text-base text-gray-400">
            Gender
          </label>
          <div className="flex gap-2 px-2">
            <div className="flex gap-1">
              <label
                htmlFor="male"
                className="leading-5 text-base text-gray-300"
              >
                Male:
              </label>
              <input
        ...
        <p className="text-white self-end">
          ...
          <Link to="/signin" className="border-b border-pink-500 text-pink-500">
            Signin
          </Link>
        </p>
      </form>
